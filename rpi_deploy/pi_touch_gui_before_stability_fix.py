...
class EcoVendApp:
    ...
    def _build_ui(self):
        ...
        # Video canvas (left) inside neon card
        video_card = tk.Frame(
            center,
            bg=ACCENT_GREEN,
        ...
        self.det_label = tk.Label(
            ...
            bg="#101820", fg=TEXT_COLOR, wraplength=210
        )
        ...
        self.status_label = tk.Label(
            ...
            bg="#101820", fg="#8b949e", wraplength=210
        )
        ...
        self.btn_start = tk.Button(
            btn_frame, text="▶  START RECYCLING", font=BUTTON_FONT,
        ...
        self.btn_next = tk.Button(
            btn_frame, text="⏭  ACCEPT ITEM", font=BUTTON_FONT,
        ...
        self.btn_finish = tk.Button(
            btn_frame, text="⏹  FINISH SESSION", font=BUTTON_FONT,
